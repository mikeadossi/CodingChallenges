...
// console.log(QuestionR1); //ask first question
// promptUser(); // Get users Y/N response and save it in variable Response
// path1(); // the first decision path


// function promptUser(){
// 	prompt.get(['Answer Y/N'], function(err, result){
// 		response = result['Answer Y/N']}
// 		if(response !== 'Y' || response !== 'N'){
// 			console.log('You must respond with a Y or an N')
// 			return false;
// 		} else{
// 			return true;
// 		}
...
// function path1(){
// 	if(response == 'Y'){
// 		console.log(QuestionR2C1); // Are the battery terminals...
// 		promptUser();
// 		path2();
// 	} else{
// 		console.log(QuestionR2C2); // Does the car make ...
// 		promptUser();
// 		path3();
// 	}
// }

// function path2(){ // After being asked 'Are the battery ...'
// 		if(response == 'Y'){
// 		console.log(AnswerR3C1); 
// 		return false; // how do I exit program?
// 	} else{
// 		console.log(AnswerR3C2);
// 		return false;
// 	}
// }

// function path3(){ // Does the car make ...'
// 		if(response == 'Y'){
// 		console.log(AnswerR3C3); 
// 		return false; 
// 	} else{
// 		console.log(QuestionR3C4); // Does the car crank ...
// 		promptUser();
// 		path4();
// 	}
// }

// function path4(){ // After being asked 'Does the car crank ...'
// 		if(response == 'Y'){
// 		console.log(AnswerR4C1);
// 		return false; 
// 	} else{
// 		console.log(QuestionR4C2);
// 		promptUser();
// 		path5()
// 	}
// }

// function path5(){ // Does the engine start and ...'
// 		if(response == 'Y'){
// 		console.log(AnswerR5C1); // Does your car have fuel ...
// 		path6() 
// 	} else{
...
// function path6(){ // Does your car have fuel injection?
// 		if(response == 'Y'){
// 		console.log(AnswerR6C1);
// 		return false; 
// 	} else{
// 		console.log(QuestionR6C2);
// 		return false;
// 	}
// }
